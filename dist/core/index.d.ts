 ...
 */
declare const unpackActions: <T extends object, K extends keyof T = keyof T>(packedActions: Record<K, TStoreFullAction<T>>, setState: TSetState<T>, getState?: TGetState<T>) => TStoreActions<T, K>;
